  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#2C5F8D] via-[#4A90E2] to-[#87CEEB]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-32 -right-32 w-[500px] h-[500px] bg-yellow-400/10 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '5s', animationDelay: '1s' }} />
        <div className="absolute top-1/3 left-1/4 w-72 h-72 bg-blue-300/10 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '6s', animationDelay: '2s' }} />
        
        {/* أشكال هندسية صغيرة */}
        <div className="absolute top-20 right-1/4 w-4 h-4 bg-yellow-400/30 rounded-full animate-bounce" 
             style={{ animationDuration: '3s' }} />
        <div className="absolute bottom-40 left-1/3 w-3 h-3 bg-white/40 rounded-full animate-bounce" 
             style={{ animationDuration: '4s', animationDelay: '1s' }} />
        <div className="absolute top-1/2 right-20 w-5 h-5 bg-blue-200/30 rounded-full animate-bounce" 
      ...
      <div className="relative z-10 flex flex-col items-center justify-center space-y-12">
        ...
        <div className="relative">
          ...
          <div className="absolute -inset-6">
            <div className="w-full h-full border-[3px] border-transparent border-t-yellow-400 border-r-yellow-400 rounded-full animate-spin" 
                 style={{ animationDuration: '3s' }} />
          </div>
          <div className="absolute -inset-8">
            <div className="w-full h-full border-[2px] border-transparent border-b-white/40 border-l-white/40 rounded-full animate-spin" 
